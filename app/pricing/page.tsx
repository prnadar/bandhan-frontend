...
const plans = [
  {
    ...
    badge: null,
    highlighted: false,
    features: ["Up to 5 daily matches", "3 interests / month", "View profiles", "AI compatibility score", "Basic search filters"],
    cta: "Get Started",
  ...
  },
  {
    ...
    badge: "Most Popular",
    highlighted: true,
    features: ["Up to 100 daily matches", "Unlimited interests", "Direct messaging", "Photo access", "Advanced search filters", "AI compatibility score", "Priority listing"],
    cta: "Choose Premium",
    ctaHref: "/auth/register",
  },
  {
