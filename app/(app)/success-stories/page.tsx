...
import { Heart, MapPin, Quote, Star, ChevronRight, Filter } from "lucide-react";
...
const stories = [
  ...
  },
  {
    ...
    quote:
      "Senthil was based in Glasgow and I was in Chennai. Match4Marriage helped coordinate our first meeting during his India visit. Three months later, we were engaged. The team was incredible.",
...
export default function SuccessStoriesPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fdfbf9", fontFamily: "var(--font-poppins, sans-serif)" }}>
      ...
      {/* ── Hero ── */}
      <div style={{
        background: "linear-gradient(135deg, #1a0a14 0%, #2d0f20 100%)",
        padding: "64px 24px",
        textAlign: "center",
      }}>
        ...
        <p style={{ fontSize: "16px", color: "rgba(255,255,255,0.6)", maxWidth: "540px", margin: "0 auto 32px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "48px", flexWrap: "wrap" }}>
          {[
            { num: "100+", label: "Couples Matched" },
            { num: "4.9★", label: "Average Rating" },
            { num: "UK", label: "Registered" },
          ].map(({ num, label }) => (
            <div key={label} style={{ textAlign: "center" }}>
              <p style={{ fontFamily: "var(--font-playfair, serif)", fontSize: "28px", fontWeight: 700, color: "#ffd87a", margin: 0 }}>{num}</p>
              <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.45)", margin: "4px 0 0" }}>{label}</p>
            </div>
          ))}
        </div>
      </div>
          ...
          {filtered.map((story) => (
            ...
            >
              ...
              <div style={{ position: "relative", height: "200px", overflow: "hidden" }}>
                {story.photo ? (
                  ...
                  <div style={{ width: "100%", height: "100%", background: story.grad, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontFamily: "var(--font-playfair, serif)", fontSize: "52px", fontWeight: 700, color: "rgba(255,255,255,0.9)" }}>
                      {story.initials}
                    </span>
                  </div>
                )}
              ...
              <div style={{ padding: "24px", flex: 1, display: "flex", flexDirection: "column" }}>
                {/* Names */}
                <h3 style={{ fontFamily: "var(--font-playfair, serif)", fontSize: "22px", fontWeight: 700, color: "#1a0a14", margin: "0 0 6px" }}>
                  {story.names}
                </h3>
                ...
                <div style={{ position: "relative", flex: 1 }}>
                  ...
                  <p style={{
                    ...
                    WebkitLineClamp: expanded === story.id ? "unset" : 3,
                ...
                <button
                  style={{ background: "none", border: "none", cursor: "pointer", fontSize: "12px", color: "#dc1e3c", fontWeight: 600, padding: "12px 0 0", textAlign: "left", display: "flex", alignItems: "center", gap: "4px" }}
                >
